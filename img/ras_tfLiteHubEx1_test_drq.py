...
interpreter = tflite.Interpreter(model_path='drq_converted_model.tflite')
...
for img, label in test_batches.take(30):
...
for index in range(0,30):
    ...
    if index %2 ==1:
      plt.show()
      imgFile = 'resultImg_drq/result{}.png'.format(index)
      plt.savefig(imgFile)
